...
public class Playlist {
    ...
    //   AF(songs) = เพลย์ลิสเพลง ที่ภายใน song
    // จะเก็บเป็นเพลง
    ...
    private void checkRep() {
        // เขียนโค้ดตรงนี้
        assert songs !=null : "song is not null";
     ...
     */
    public boolean contains(String song) { //ของ play list
        return songs.contains(song);  //ของ ArrayList
    }
